...
global $post;
if($post->ID == 105616):
    $ft_style = 'display:block'; $mc_class = 'open';

    echo '
    <style>#banner-wrapper,#banner-spacer, #footer-top,#footer-social { display: none; }</style>
    ';
...
<div id="footer-signup" style="<?php echo $ft_style ?>">
<div class="container">
	<!--<a href="<?php //the_field('ftr_signup_link','option'); ?>" target="_blank" class="trans-0-3"><?php //the_field('ftr_signup_text','option'); ?></a>-->
    <div class="sign-up trans-0-3"><?php the_field('ftr_signup_text','option'); ?></div>
...
<div id="mc_embed_signup" class="<?php echo $mc_class ?>">
