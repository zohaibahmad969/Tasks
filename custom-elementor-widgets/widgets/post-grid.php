 ...
 * @since 1.1.0
 */
class Elementor_Custom_Post_Grid_Widget extends Widget_Base {

	public function get_name() {
		return 'elementor-kd-blog-posts';
	}

	public function get_title() {
		return __( 'Custom Post Grid', 'elementor' );
	}
	...
	private function wpkd_get_all_posts() {
		...
		if ( ! empty( $post_types ) ) {
			foreach ($post_types  as $post_type) {
				$options[ esc_attr($post_type) ] = esc_html($post_type);
			}
		}
	...
	protected function register_controls() {
		...
		$this->wpkd_style_meta_options();
		$this->wpkd_style_content_options();
		$this->wpkd_style_readmore_options();
		$this->wpkd_style_author_box_options();
		$this->wpkd_style_pagination_options();
	...
	private function wpkd_content_layout_options() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'categories' => __( 'Categories', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '/',
				'selectors' => [
					'{{WRAPPER}} .wpkd-grid-container .wpkd-post .post-grid-meta span + span:before' => 'content: "{{VALUE}}"',
				],
				'condition' => [
					'meta_data!' => [],
				],
	...
	private function wpkd_content_query_options() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::SELECT,
				'default' => 'post',
				'options'     => $this->wpkd_get_all_posts(),
	 ...
	 * Style > Title.
	 */
	private function wpkd_style_author_box_options() {
		// Tab.
		$this->start_controls_section(
			'section_grid_author_style',
			[
...
// Image border radius.
		$this->add_control(
			'grid_author_image_border_radius',
			[
				'label'      => __( 'Border Radius', 'elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .post-grid-inner .post-grid-author img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);

		$this->add_responsive_control(
			'grid_style_author_image_margin',
			[
				'label'      => __( 'Margin', 'elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .post-grid-inner .post-grid-author img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'grid_author_style_typography',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
				],
				'selector' => '{{WRAPPER}} .wpkd-grid-container .wpkd-post .author-post__title, {{WRAPPER}} .wpkd-grid-container .wpkd-post .author-post__title > a',
			]
		);

		//$this->start_controls_tabs( 'section_grid_author_style' );

		// Title color.
		$this->add_control(
			'grid_author_style_color',
			[
				'type'      => Controls_Manager::COLOR,
				...
				'selectors' => [
					'{{WRAPPER}} .wpkd-grid-container .wpkd-post .author-post__title, {{WRAPPER}} .wpkd-grid-container .wpkd-post .author-post__title > a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wpkd-grid-container .wpkd-post .post-grid-author img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	 ...
	 * Style > Meta.
	 */
	private function wpkd_style_meta_options() {
		// Tab.
		$this->start_controls_section(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wpkd-grid-container .wpkd-post .post-grid-meta span a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .wpkd-grid-container .wpkd-post .post-grid-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	 ...
	 * Style > Readmore.
	 */
	private function wpkd_style_pagination_options() {
		// Tab.
		$this->start_controls_section(
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'      => 'grid_pagination_style_typography',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_ACCENT,
				],
				'selector'  => 'nav.pagination a, nav.pagination span',
			]
		);

		$this->start_controls_tabs( 'grid_pagination_color_style' );

		// Normal tab.
		$this->start_controls_tab(
			'grid_pagination_style_normal',
			array(
				'label' => esc_html__( 'Normal', 'elementor' ),
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'.pagination .nav-links a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'grid_pagination_style_background_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Background Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links a' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'grid_pagination_style_border_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Border Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links a' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		// Hover tab.
		$this->start_controls_tab(
			'grid_pagination_style_color_hover_tab',
			array(
				'label' => esc_html__( 'Hover', 'elementor' ),
			)
		);
		...
		$this->add_control(
			'grid_pagination_style_hover_color',
			array(
				'type'      => Controls_Manager::COLOR,
				'label'     => esc_html__( 'Color', 'elementor' ),
				'global' => [
				...
				'selectors' => array(
					'.pagination .nav-links a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			'grid_pagination_style_hover_background_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Background Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links a:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'grid_pagination_style_hover_border_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Border Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links a:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		// Hover tab.
		$this->start_controls_tab(
			'grid_pagination_style_color_active_tab',
			array(
		...
		// Readmore hover color.
		$this->add_control(
			'grid_pagination_style_active_color',
			array(
				'type'      => Controls_Manager::COLOR,
				'label'     => esc_html__( 'Color', 'elementor' ),
				'global' => [
				...
				'selectors' => array(
					'.pagination .nav-links span.current' => 'color: {{VALUE}};',
				),
			)
		);
		...
		// Readmore hover background color.
		$this->add_control(
			'grid_pagination_style_active_background_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Background Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links span.current' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		// Readmore hover border color.
		$this->add_control(
			'grid_pagination_style_active_border_color',
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Border Color', 'elementor' ),
				'selectors' => [
					'.pagination .nav-links span.current' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'grid_pagination_style_border_width',
			[
				'type'       => Controls_Manager::DIMENSIONS,
				...
				'size_units' => array( 'px' ),
				'selectors'  => [
					'.pagination .nav-links a, .pagination .nav-links span' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.pagination .nav-links a, .pagination .nav-links span' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}} !important;',
				),
			)
		);
		...
		// Readmore margin.
		$this->add_responsive_control(
			'grid_pagination_style_border_radius',
			[
				'label'      => __( 'Border Radius', 'elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'.pagination .nav-links a,.pagination .nav-links span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);
	...
	protected function render( $instance = [] ) {
		...
		<div class="wpkd-grid">
			...
			<div class="wpkd-grid-container <?php echo $grid_elem_class.' '.$columns_desktop.$columns_tablet.$columns_mobile.$grid_class; ?>">
				...
				$posts_post_type = is_array( $settings['posts_post_type'] ) ? implode( ',', $settings['posts_post_type'] ) : $settings['posts_post_type'];
		        ...
		        if ( $all_posts->have_posts() ) :
		        	...
		        	if( 6 == $grid_style ){
		        		...
		        		include( __DIR__ . '/layouts/layout-carousel.php' );
					...
					if ( 'yes' === $settings['show_pagination'] ) {
						echo get_the_posts_pagination( array(
							'prev_text'          => __( '', 'elementor' ),
							'next_text'          => __( '', 'elementor' ),
							'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'elementor' ) . ' </span>',
						) );
					}
					}*/
                else:
